...
const breadcrumbs = [{ label: 'Academics', path: '/academics' }, { label: 'Question Import' }];

export default function ClassTestQuestionImport() {
  ...
  return (
    <Box>
      <PageHeader title="Class Test Question Import" breadcrumbs={breadcrumbs} />
      <Paper sx={{ p: 3, mb: 3 }}>
      ...
      {results.length > 0 && <DataTable rows={results} columns={columns} exportFilename="questions-import" />}
    </Box>
  );
}
