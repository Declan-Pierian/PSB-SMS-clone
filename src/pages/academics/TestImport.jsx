...
const breadcrumbs = [{ label: 'Academics', path: '/academics' }, { label: 'Test Import' }];
...
export default function TestImport() {
  ...
  return (
    <Box>
      <PageHeader title="Test Import" breadcrumbs={breadcrumbs} />
      <Paper sx={{ p: 3, mb: 3 }}>
      ...
      {results.length > 0 && <DataTable rows={results} columns={columns} exportFilename="tests-import" />}
    </Box>
  );
}
