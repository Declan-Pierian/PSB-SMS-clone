...
const breadcrumbs = [{ label: 'Academics', path: '/academics' }, { label: 'Question Ingestor' }];

export default function QuestionIngestor() {
  ...
  return (
    <Box>
      <PageHeader title="Question Ingestor" breadcrumbs={breadcrumbs} />
      <Paper sx={{ p: 3, mb: 3 }}>
