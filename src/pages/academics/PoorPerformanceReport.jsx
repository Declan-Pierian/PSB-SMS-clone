...
const breadcrumbs = [{ label: 'Academics', path: '/academics' }, { label: 'Poor Performance Report' }];

export default function PoorPerformanceReport() {
  ...
  return (
    <Box>
      <PageHeader title="Poor Performance Report" breadcrumbs={breadcrumbs} />
