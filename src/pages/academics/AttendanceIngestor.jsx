...
const breadcrumbs = [{ label: 'Academics', path: '/academics' }, { label: 'Attendance Ingestor' }];

export default function AttendanceIngestor() {
  ...
  return (
    <Box>
      <PageHeader title="Attendance Ingestor" breadcrumbs={breadcrumbs} />
      <Paper sx={{ p: 3, mb: 3 }}>
      ...
      {results.length > 0 && <DataTable rows={results} columns={columns} exportFilename="attendance-import" />}
    </Box>
  );
}
