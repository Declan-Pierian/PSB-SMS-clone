...
const formFields = [
  ...
  { name: 'headOfDepartment', label: 'Head of Department', type: 'text' },
...
export default function DepartmentManagement() {
  ...
  const columns = [
    ...
    { field: 'headOfDepartment', headerName: 'Head of Department', flex: 1.2, minWidth: 160 },
    { field: 'employeeCount', headerName: 'Employee Count', flex: 0.8, minWidth: 120 },
  ...
  return (
    <Box>
      ...
      <DataTable rows={data} columns={columns} exportFilename="departments" />
